...
/**
 * 可以在TextView显示的Drawable
 * 用于TextView.setCompoundDrawables方法
 * Created by beiying on 2016/4/7.
 */
public class BYTextDrawable extends Drawable implements TextWatcher {
     ...
     * @param s the string
     */
    public BYTextDrawable(Paint paint, String s) {
        mText = s;
     ...
     */
    public BYTextDrawable(TextView tv, String initialText, boolean bindToViewsText, boolean bindToViewsPaint) {
     ...
     *                         Note, this will override any changes made using setColorFilter or setAlpha.
     */
    public BYTextDrawable(TextView tv, boolean bindToViewsText, boolean bindToViewsPaint) {
     ...
     */
    public BYTextDrawable(TextView tv) {
        this(tv, false, false);
    }
     ...
     */
    public BYTextDrawable(TextView tv, String s) {
